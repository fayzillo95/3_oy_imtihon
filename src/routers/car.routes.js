...
cars_router.put("/api/cars/v2/update/:id",updateValid ,CarsController.updateCars, CarsResponseMidllware)
cars_router.delete("/api/cars/v3/delete/:id",  CarsController.deleteCars, CarsResponseMidllware)
